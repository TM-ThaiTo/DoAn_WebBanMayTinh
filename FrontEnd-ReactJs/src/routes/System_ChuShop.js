...
import Navbar1 from '../containers/System/Navbar/Navbar.js';

import './System.scss';

class System_ChuShop extends Component {
    render() {
...
export default connect(mapStateToProps, mapDispatchToProps)(System_ChuShop);
