...
import backgroundImage from '../../../../assets/logo-banner/nengear.png';

const mockProducts = [
    {
        _id: '1',
        avt: 'https://res.cloudinary.com/duvnxrvqr/image/upload/v1710045218/Image/Gear.webp',
...
class Gear extends Component {
    ...
    render() {
        ...
        return (
            <div className="Gear-container" style={{ backgroundImage: `url(${backgroundImage})` }}>
                <Row className="p-16" style={{ minHeight: 400 }} gutter={[16, 16]}>
                    <Col span={24}>
                        <h2 className="font-weight-700">Doanh mục Gear</h2>
